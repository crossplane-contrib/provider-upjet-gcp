...
to the [latest release](https://github.com/upbound/official-providers/provider-gcp/releases):
```
kubectl crossplane install provider upbound/provider-gcp:v0.1.0
```

You can see the API reference [here](https://doc.crds.dev/github.com/upbound/official-providers/provider-gcp).
...
open an [issue](https://github.com/upbound/official-providers/provider-gcp/issues).
