	...
	cases := map[string]struct {
		...
		"SecretAlreadyFull": {
			...
			args: args{
				...
				secretRefFieldPath: "parameterizable.parameters.rootPasswordSecretRef",
				mg: &ujfake.Terraformed{
					Parameterizable: ujfake.Parameterizable{
						Parameters: map[string]any{
							"rootPasswordSecretRef": map[string]any{
								"name":      "foo",
								"namespace": "bar",
								"key":       "password",
							},
		...
		"ToggleNotSet": {
			...
			args: args{
				...
				secretRefFieldPath: "parameterizable.parameters.rootPasswordSecretRef",
				toggleFieldPath:    "parameterizable.parameters.autoGenerateRootPassword",
				mg: &ujfake.Terraformed{
					Parameterizable: ujfake.Parameterizable{
						Parameters: map[string]any{
							"rootPasswordSecretRef": map[string]any{
				...
				mg: &ujfake.Terraformed{
					Parameterizable: ujfake.Parameterizable{
						Parameters: map[string]any{
							...
							"autoGenerateRootPassword": false,
						},
					},
				},
			},
