...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("google_storage_bucket", func(r *config.Resource) {
		...
		r.Conversions = []conversion.Conversion{
			...
			conversion.NewFieldTypeConversion("v1beta1", "v1beta2", "spec.forProvider.retentionPolicy.retentionPeriod", conversion.FloatToString),
			conversion.NewFieldTypeConversion("v1beta1", "v1beta2", "spec.initProvider.retentionPolicy.retentionPeriod", conversion.FloatToString),
			conversion.NewFieldTypeConversion("v1beta1", "v1beta2", "status.atProvider.retentionPolicy.retentionPeriod", conversion.FloatToString),
			conversion.NewFieldTypeConversion("v1beta2", "v1beta1", "spec.forProvider.retentionPolicy.retentionPeriod", conversion.StringToFloat),
			conversion.NewFieldTypeConversion("v1beta2", "v1beta1", "spec.initProvider.retentionPolicy.retentionPeriod", conversion.StringToFloat),
			conversion.NewFieldTypeConversion("v1beta2", "v1beta1", "status.atProvider.retentionPolicy.retentionPeriod", conversion.StringToFloat),
		}
	})
