...
const (
	...
	SelfPackagePath = "github.com/upbound/provider-gcp/v3/config/namespaced/common"

	// ExtractResourceIDFuncPath holds the GCP resource ID extractor func name
	ExtractResourceIDFuncPath = "github.com/upbound/provider-gcp/v3/config/namespaced/common.ExtractResourceID()"
	ExtractProjectIDFuncPath  = "github.com/upbound/provider-gcp/v3/config/namespaced/common.ExtractProjectID()"
	ExtractFolderIDFuncPath   = "github.com/upbound/provider-gcp/v3/config/namespaced/common.ExtractFolderID()"
