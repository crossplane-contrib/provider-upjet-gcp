...
func TestNetworkFirewallPolicyAssociationReadWrapper(t *testing.T) {
	type args struct {
		origErr error
		id      string
	}
	...
	cases := map[string]struct {
		...
		"NotFoundError": {
			...
			args: args{
				...
				id:      "projects/my-project/global/firewallPolicies/1234567890123456789/associations/my-network",
			},
			want: want{
				err: nil,
				id:  "",
