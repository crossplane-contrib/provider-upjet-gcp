...
const (
	...
	SelfPackagePath = "github.com/upbound/provider-gcp/v3/config/cluster/common"

	// ExtractResourceIDFuncPath holds the GCP resource ID extractor func name
	ExtractResourceIDFuncPath = "github.com/upbound/provider-gcp/v3/config/cluster/common.ExtractResourceID()"
	ExtractProjectIDFuncPath  = "github.com/upbound/provider-gcp/v3/config/cluster/common.ExtractProjectID()"
	ExtractFolderIDFuncPath   = "github.com/upbound/provider-gcp/v3/config/cluster/common.ExtractFolderID()"
