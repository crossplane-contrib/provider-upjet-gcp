...
var terraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"google_dataplex_aspect_type": config.TemplatedStringAsIdentifier("name", "projects/{{ .setup.configuration.project }}/locations/{{ .parameters.location }}/aspectTypes/{{ .external_name }}"),
