...
func (in *NodePoolInitParameters) DeepCopyInto(out *NodePoolInitParameters) {
	*out = *in
	...
	if in.UpdateSettings != nil {
		...
		*out = make([]UpdateSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodePoolObservation) DeepCopyInto(out *NodePoolObservation) {
	*out = *in
	...
	if in.UpdateSettings != nil {
		in, out := &in.UpdateSettings, &out.UpdateSettings
		*out = make([]UpdateSettingsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodePoolParameters) DeepCopyInto(out *NodePoolParameters) {
	*out = *in
	...
	if in.UpdateSettings != nil {
		in, out := &in.UpdateSettings, &out.UpdateSettings
		*out = make([]UpdateSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UpdateSettingsInitParameters) DeepCopyInto(out *UpdateSettingsInitParameters) {
	*out = *in
	if in.SurgeSettings != nil {
		...
		*out = make([]SurgeSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UpdateSettingsObservation) DeepCopyInto(out *UpdateSettingsObservation) {
	*out = *in
	if in.SurgeSettings != nil {
		in, out := &in.SurgeSettings, &out.SurgeSettings
		*out = make([]SurgeSettingsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UpdateSettingsParameters) DeepCopyInto(out *UpdateSettingsParameters) {
	*out = *in
	if in.SurgeSettings != nil {
		in, out := &in.SurgeSettings, &out.SurgeSettings
		*out = make([]SurgeSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
