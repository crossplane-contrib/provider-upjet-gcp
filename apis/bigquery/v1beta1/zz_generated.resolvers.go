	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.BigqueryDataset); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.BigqueryDataset[i3].Dataset, ""),
		...
		mg.Spec.ForProvider.BigqueryDataset[i3].Dataset = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.BigqueryDataset); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.BigqueryDataset[i3].Dataset, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.BigqueryDataset[i3].Dataset = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.CloudSQL[i3].Credential); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.CloudSQL[i3].Credential[i4].Username, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.CloudSQL[i3].Credential[i4].Username = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CloudSQL); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.CloudSQL[i3].Database, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.ForProvider.CloudSQL[i3].Database = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CloudSQL); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.CloudSQL[i3].InstanceID, ""),
		...
		mg.Spec.ForProvider.CloudSQL[i3].InstanceID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Spark[i3].SparkHistoryServerConfig); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Spark[i3].SparkHistoryServerConfig[i4].DataprocCluster, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Spark[i3].SparkHistoryServerConfig[i4].DataprocCluster = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.CloudSQL[i3].Credential); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.CloudSQL[i3].Credential[i4].Username, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.CloudSQL[i3].Credential[i4].Username = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.CloudSQL); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.CloudSQL[i3].Database, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.CloudSQL[i3].Database = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.CloudSQL); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.CloudSQL[i3].InstanceID, ""),
				Extract:      resource.ExtractParamPath("connection_name", true),
		...
		mg.Spec.InitProvider.CloudSQL[i3].InstanceID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Spark[i3].SparkHistoryServerConfig); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Spark[i3].SparkHistoryServerConfig[i4].DataprocCluster, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Spark[i3].SparkHistoryServerConfig[i4].DataprocCluster = ptr.To(rsp.ResolvedValue)
			...
			for i5 := 0; i5 < len(mg.Spec.ForProvider.Access[i3].Dataset[i4].Dataset); i5++ {
				{
					...
					rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
						CurrentValue: ptr.Deref(mg.Spec.ForProvider.Access[i3].Dataset[i4].Dataset[i5].DatasetID, ""),
						Extract:      reference.ExternalName(),
				...
				mg.Spec.ForProvider.Access[i3].Dataset[i4].Dataset[i5].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Access[i3].Routine[i4].DatasetID, ""),
			...
			mg.Spec.ForProvider.Access[i3].Routine[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Access[i3].Routine[i4].ProjectID, ""),
			...
			mg.Spec.ForProvider.Access[i3].Routine[i4].ProjectID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Access[i3].Routine[i4].RoutineID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Access[i3].Routine[i4].RoutineID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.DefaultEncryptionConfiguration); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.DefaultEncryptionConfiguration[i3].KMSKeyName, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.ForProvider.DefaultEncryptionConfiguration[i3].KMSKeyName = ptr.To(rsp.ResolvedValue)
			...
			for i5 := 0; i5 < len(mg.Spec.InitProvider.Access[i3].Dataset[i4].Dataset); i5++ {
				{
					...
					rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
						CurrentValue: ptr.Deref(mg.Spec.InitProvider.Access[i3].Dataset[i4].Dataset[i5].DatasetID, ""),
						Extract:      reference.ExternalName(),
				...
				mg.Spec.InitProvider.Access[i3].Dataset[i4].Dataset[i5].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Access[i3].Routine[i4].DatasetID, ""),
					Extract:      resource.ExtractParamPath("dataset_id", false),
			...
			mg.Spec.InitProvider.Access[i3].Routine[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Access[i3].Routine[i4].ProjectID, ""),
					Extract:      resource.ExtractParamPath("project", false),
			...
			mg.Spec.InitProvider.Access[i3].Routine[i4].ProjectID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Access[i3].Routine); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Access[i3].Routine[i4].RoutineID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Access[i3].Routine[i4].RoutineID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.DefaultEncryptionConfiguration); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.DefaultEncryptionConfiguration[i3].KMSKeyName, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.DefaultEncryptionConfiguration[i3].KMSKeyName = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Dataset[i3].Dataset); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Dataset[i3].Dataset[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Dataset[i3].Dataset[i4].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.Routine[i3].DatasetID, ""),
				Extract:      resource.ExtractParamPath("dataset_id", false),
		...
		mg.Spec.ForProvider.Routine[i3].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.Routine[i3].ProjectID, ""),
				Extract:      resource.ExtractParamPath("project", false),
		...
		mg.Spec.ForProvider.Routine[i3].ProjectID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.Routine[i3].RoutineID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.ForProvider.Routine[i3].RoutineID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.View); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.View[i3].DatasetID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.ForProvider.View[i3].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.View); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.View[i3].TableID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.ForProvider.View[i3].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Dataset[i3].Dataset); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Dataset[i3].Dataset[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Dataset[i3].Dataset[i4].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.Routine[i3].DatasetID, ""),
				Extract:      resource.ExtractParamPath("dataset_id", false),
		...
		mg.Spec.InitProvider.Routine[i3].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.Routine[i3].ProjectID, ""),
				Extract:      resource.ExtractParamPath("project", false),
		...
		mg.Spec.InitProvider.Routine[i3].ProjectID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Routine); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.Routine[i3].RoutineID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.Routine[i3].RoutineID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.View); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.View[i3].DatasetID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.View[i3].DatasetID = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.View); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.View[i3].TableID, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.View[i3].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Copy[i3].DestinationEncryptionConfiguration); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Copy[i3].DestinationEncryptionConfiguration[i4].KMSKeyName, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Copy[i3].DestinationEncryptionConfiguration[i4].KMSKeyName = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Copy[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Copy[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Copy[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Copy[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Copy[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Copy[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Extract[i3].SourceTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Extract[i3].SourceTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Extract[i3].SourceTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Extract[i3].SourceTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Extract[i3].SourceTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Extract[i3].SourceTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Load[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Load[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Load[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Load[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Load[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Load[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Query[i3].DefaultDataset); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Query[i3].DefaultDataset[i4].DatasetID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Query[i3].DefaultDataset[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Query[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Query[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.ForProvider.Query[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Query[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Query[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.ForProvider.Query[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Copy[i3].DestinationEncryptionConfiguration); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Copy[i3].DestinationEncryptionConfiguration[i4].KMSKeyName, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Copy[i3].DestinationEncryptionConfiguration[i4].KMSKeyName = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Copy[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Copy[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Copy[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Copy[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Copy[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Copy[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Extract[i3].SourceTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Extract[i3].SourceTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Extract[i3].SourceTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Extract[i3].SourceTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Extract[i3].SourceTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Extract[i3].SourceTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Load[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Load[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Load[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Load[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Load[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Load[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Query[i3].DefaultDataset); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Query[i3].DefaultDataset[i4].DatasetID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Query[i3].DefaultDataset[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Query[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Query[i3].DestinationTable[i4].DatasetID, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Query[i3].DestinationTable[i4].DatasetID = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Query[i3].DestinationTable); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Query[i3].DestinationTable[i4].TableID, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.Query[i3].DestinationTable[i4].TableID = ptr.To(rsp.ResolvedValue)
...
func (mg *ReservationAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		...
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			CurrentValue: ptr.Deref(mg.Spec.ForProvider.Reservation, ""),
			Extract:      resource.ExtractResourceID(),
	...
	mg.Spec.ForProvider.Reservation = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.RemoteFunctionOptions); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.RemoteFunctionOptions[i3].Connection, ""),
		...
		mg.Spec.ForProvider.RemoteFunctionOptions[i3].Connection = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.SparkOptions); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.SparkOptions[i3].Connection, ""),
				Extract:      resource.ExtractParamPath("name", true),
		...
		mg.Spec.ForProvider.SparkOptions[i3].Connection = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.RemoteFunctionOptions); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.RemoteFunctionOptions[i3].Connection, ""),
				Extract:      resource.ExtractParamPath("name", true),
		...
		mg.Spec.InitProvider.RemoteFunctionOptions[i3].Connection = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.SparkOptions); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.SparkOptions[i3].Connection, ""),
				Extract:      resource.ExtractParamPath("name", true),
		...
		mg.Spec.InitProvider.SparkOptions[i3].Connection = ptr.To(rsp.ResolvedValue)
