		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Destination[i3].CloudRunService); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.Destination[i3].CloudRunService[i4].Service, ""),
			...
			mg.Spec.ForProvider.Destination[i3].CloudRunService[i4].Service = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Destination[i3].CloudRunService); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.Destination[i3].CloudRunService[i4].Service, ""),
					Extract:      reference.ExternalName(),
			...
			mg.Spec.InitProvider.Destination[i3].CloudRunService[i4].Service = ptr.To(rsp.ResolvedValue)
