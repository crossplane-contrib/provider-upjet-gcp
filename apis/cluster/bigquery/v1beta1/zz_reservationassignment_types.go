...
type ReservationAssignmentParameters struct {
	...
	// The reservation for the resource
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/cluster/bigquery/v1beta2.Reservation
	...
	// +kubebuilder:validation:Optional
	ReservationRef *v2.Reference `json:"reservationRef,omitempty" tf:"-"`

	// Selector for a Reservation in bigquery to populate reservation.
	// +kubebuilder:validation:Optional
	ReservationSelector *v2.Selector `json:"reservationSelector,omitempty" tf:"-"`
}
