...
// ConvertTo converts this TableIAMPolicy to the hub type.
func (tr *TableIAMPolicy) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the TableIAMPolicy type.
func (tr *TableIAMPolicy) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
