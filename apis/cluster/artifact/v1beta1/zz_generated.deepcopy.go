...
func (in *RegistryRepositoryInitParameters) DeepCopyInto(out *RegistryRepositoryInitParameters) {
	*out = *in
	...
	if in.VulnerabilityScanningConfig != nil {
		...
		*out = make([]VulnerabilityScanningConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegistryRepositoryObservation) DeepCopyInto(out *RegistryRepositoryObservation) {
	*out = *in
	...
	if in.VulnerabilityScanningConfig != nil {
		in, out := &in.VulnerabilityScanningConfig, &out.VulnerabilityScanningConfig
		*out = make([]VulnerabilityScanningConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegistryRepositoryParameters) DeepCopyInto(out *RegistryRepositoryParameters) {
	*out = *in
	...
	if in.VulnerabilityScanningConfig != nil {
		in, out := &in.VulnerabilityScanningConfig, &out.VulnerabilityScanningConfig
		*out = make([]VulnerabilityScanningConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RemoteRepositoryConfigInitParameters) DeepCopyInto(out *RemoteRepositoryConfigInitParameters) {
	*out = *in
	...
	if in.CommonRepository != nil {
		...
		*out = make([]CommonRepositoryInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RemoteRepositoryConfigObservation) DeepCopyInto(out *RemoteRepositoryConfigObservation) {
	*out = *in
	...
	if in.CommonRepository != nil {
		in, out := &in.CommonRepository, &out.CommonRepository
		*out = make([]CommonRepositoryObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RemoteRepositoryConfigParameters) DeepCopyInto(out *RemoteRepositoryConfigParameters) {
	*out = *in
	...
	if in.CommonRepository != nil {
		in, out := &in.CommonRepository, &out.CommonRepository
		*out = make([]CommonRepositoryParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
