...
type BackupScheduleParameters struct {
	...
	// The database to create the backup schedule on.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/cluster/spanner/v1beta2.Database
	...
	// The instance to create the database on.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/cluster/spanner/v1beta2.Instance
	// +kubebuilder:validation:Optional
	Instance *string `json:"instance,omitempty" tf:"instance,omitempty"`
