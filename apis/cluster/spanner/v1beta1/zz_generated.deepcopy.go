...
func (in *AsymmetricAutoscalingOptionsInitParameters) DeepCopyInto(out *AsymmetricAutoscalingOptionsInitParameters) {
	*out = *in
	...
	if in.ReplicaSelection != nil {
		...
		*out = make([]ReplicaSelectionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AsymmetricAutoscalingOptionsObservation) DeepCopyInto(out *AsymmetricAutoscalingOptionsObservation) {
	*out = *in
	...
	if in.ReplicaSelection != nil {
		in, out := &in.ReplicaSelection, &out.ReplicaSelection
		*out = make([]ReplicaSelectionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AsymmetricAutoscalingOptionsParameters) DeepCopyInto(out *AsymmetricAutoscalingOptionsParameters) {
	*out = *in
	...
	if in.ReplicaSelection != nil {
		in, out := &in.ReplicaSelection, &out.ReplicaSelection
		*out = make([]ReplicaSelectionParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingConfigInitParameters) DeepCopyInto(out *AutoscalingConfigInitParameters) {
	*out = *in
	...
	if in.AutoscalingLimits != nil {
		...
		*out = make([]AutoscalingConfigAutoscalingLimitsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingConfigObservation) DeepCopyInto(out *AutoscalingConfigObservation) {
	*out = *in
	...
	if in.AutoscalingLimits != nil {
		in, out := &in.AutoscalingLimits, &out.AutoscalingLimits
		*out = make([]AutoscalingConfigAutoscalingLimitsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingConfigParameters) DeepCopyInto(out *AutoscalingConfigParameters) {
	*out = *in
	...
	if in.AutoscalingLimits != nil {
		in, out := &in.AutoscalingLimits, &out.AutoscalingLimits
		*out = make([]AutoscalingConfigAutoscalingLimitsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
