...
type SharedVPCServiceProjectInitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-gcp/v3/config/cluster/common.ExtractProjectID()
	...
	HostProjectRef *v2.Reference `json:"hostProjectRef,omitempty" tf:"-"`

	// Selector for a Project in cloudplatform to populate hostProject.
	// +kubebuilder:validation:Optional
	HostProjectSelector *v2.Selector `json:"hostProjectSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ServiceProjectRef *v2.Reference `json:"serviceProjectRef,omitempty" tf:"-"`

	// Selector for a Project in cloudplatform to populate serviceProject.
	// +kubebuilder:validation:Optional
	ServiceProjectSelector *v2.Selector `json:"serviceProjectSelector,omitempty" tf:"-"`
}
