...
type RegionDiskAsyncPrimaryDiskInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/cluster/compute/v1beta2.RegionDisk
...
type RegionDiskInitParameters struct {
	...
	// valid values:
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/cluster/compute/v1beta2.Snapshot
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	Snapshot *string `json:"snapshot,omitempty" tf:"snapshot,omitempty"`

	// Reference to a Snapshot in compute to populate snapshot.
	// +kubebuilder:validation:Optional
	SnapshotRef *v2.Reference `json:"snapshotRef,omitempty" tf:"-"`

	// Selector for a Snapshot in compute to populate snapshot.
	// +kubebuilder:validation:Optional
	SnapshotSelector *v2.Selector `json:"snapshotSelector,omitempty" tf:"-"`
