...
func (tr *Cluster) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("LoggingConfig"))
	opts = append(opts, resource.WithNameFilter("LoggingService"))
	opts = append(opts, resource.WithNameFilter("MonitoringConfig"))
	opts = append(opts, resource.WithNameFilter("MonitoringService"))
