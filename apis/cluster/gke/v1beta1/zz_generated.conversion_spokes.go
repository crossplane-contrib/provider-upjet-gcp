...
// ConvertTo converts this BackupBackupPlan to the hub type.
func (tr *BackupBackupPlan) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the BackupBackupPlan type.
func (tr *BackupBackupPlan) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
