...
type OrganizationInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	RuntimeDatabaseEncryptionKeyNameRef *v2.Reference `json:"runtimeDatabaseEncryptionKeyNameRef,omitempty" tf:"-"`

	// Selector for a CryptoKey in kms to populate runtimeDatabaseEncryptionKeyName.
	// +kubebuilder:validation:Optional
	RuntimeDatabaseEncryptionKeyNameSelector *v2.Selector `json:"runtimeDatabaseEncryptionKeyNameSelector,omitempty" tf:"-"`
