...
func (mg *Developer) GetTerraformResourceType() string {
	return "google_apigee_developer"
}
...
func (tr *Developer) GetObservation() (map[string]any, error) {
...
func (tr *Developer) SetObservation(obs map[string]any) error {
...
func (tr *Developer) GetParameters() (map[string]any, error) {
...
func (tr *Developer) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Developer
func (tr *Developer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Developer
func (tr *Developer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
