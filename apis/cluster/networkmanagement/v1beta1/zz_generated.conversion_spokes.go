...
// ConvertTo converts this ConnectivityTest to the hub type.
func (tr *ConnectivityTest) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ConnectivityTest type.
func (tr *ConnectivityTest) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
