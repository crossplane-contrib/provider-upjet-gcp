...
// ConvertTo converts this Backup to the hub type.
func (tr *Backup) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Backup type.
func (tr *Backup) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
