...
func (in *ConditionSQLInitParameters) DeepCopyInto(out *ConditionSQLInitParameters) {
	*out = *in
	if in.BooleanTest != nil {
		...
		*out = make([]BooleanTestInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Minutes != nil {
		...
		*out = make([]MinutesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.RowCountTest != nil {
		...
		*out = make([]RowCountTestInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConditionSQLObservation) DeepCopyInto(out *ConditionSQLObservation) {
	*out = *in
	if in.BooleanTest != nil {
		in, out := &in.BooleanTest, &out.BooleanTest
		*out = make([]BooleanTestObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Minutes != nil {
		in, out := &in.Minutes, &out.Minutes
		*out = make([]MinutesObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.RowCountTest != nil {
		in, out := &in.RowCountTest, &out.RowCountTest
		*out = make([]RowCountTestObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConditionSQLParameters) DeepCopyInto(out *ConditionSQLParameters) {
	*out = *in
	if in.BooleanTest != nil {
		in, out := &in.BooleanTest, &out.BooleanTest
		*out = make([]BooleanTestParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Minutes != nil {
		in, out := &in.Minutes, &out.Minutes
		*out = make([]MinutesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.RowCountTest != nil {
		in, out := &in.RowCountTest, &out.RowCountTest
		*out = make([]RowCountTestParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConditionsInitParameters) DeepCopyInto(out *ConditionsInitParameters) {
	*out = *in
	...
	if in.ConditionSQL != nil {
		...
		*out = make([]ConditionSQLInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConditionsObservation) DeepCopyInto(out *ConditionsObservation) {
	*out = *in
	...
	if in.ConditionSQL != nil {
		in, out := &in.ConditionSQL, &out.ConditionSQL
		*out = make([]ConditionSQLObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConditionsParameters) DeepCopyInto(out *ConditionsParameters) {
	*out = *in
	...
	if in.ConditionSQL != nil {
		in, out := &in.ConditionSQL, &out.ConditionSQL
		*out = make([]ConditionSQLParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DailyInitParameters) DeepCopyInto(out *DailyInitParameters) {
	*out = *in
	if in.ExecutionTime != nil {
		...
		*out = make([]ExecutionTimeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DailyObservation) DeepCopyInto(out *DailyObservation) {
	*out = *in
	if in.ExecutionTime != nil {
		in, out := &in.ExecutionTime, &out.ExecutionTime
		*out = make([]ExecutionTimeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DailyParameters) DeepCopyInto(out *DailyParameters) {
	*out = *in
	if in.ExecutionTime != nil {
		in, out := &in.ExecutionTime, &out.ExecutionTime
		*out = make([]ExecutionTimeParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MonitoredProject) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectInitParameters) DeepCopyInto(out *MonitoredProjectInitParameters) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectInitParameters.
func (in *MonitoredProjectInitParameters) DeepCopy() *MonitoredProjectInitParameters {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectList) DeepCopyInto(out *MonitoredProjectList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MonitoredProject, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectList.
func (in *MonitoredProjectList) DeepCopy() *MonitoredProjectList {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MonitoredProjectList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectObservation) DeepCopyInto(out *MonitoredProjectObservation) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectObservation.
func (in *MonitoredProjectObservation) DeepCopy() *MonitoredProjectObservation {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectParameters) DeepCopyInto(out *MonitoredProjectParameters) {
	*out = *in
	if in.MetricsScope != nil {
		in, out := &in.MetricsScope, &out.MetricsScope
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectParameters.
func (in *MonitoredProjectParameters) DeepCopy() *MonitoredProjectParameters {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectSpec) DeepCopyInto(out *MonitoredProjectSpec) {
	*out = *in
	in.ResourceSpec.DeepCopyInto(&out.ResourceSpec)
	in.ForProvider.DeepCopyInto(&out.ForProvider)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectSpec.
func (in *MonitoredProjectSpec) DeepCopy() *MonitoredProjectSpec {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MonitoredProjectStatus) DeepCopyInto(out *MonitoredProjectStatus) {
	*out = *in
	in.ResourceStatus.DeepCopyInto(&out.ResourceStatus)
	in.AtProvider.DeepCopyInto(&out.AtProvider)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MonitoredProjectStatus.
func (in *MonitoredProjectStatus) DeepCopy() *MonitoredProjectStatus {
	if in == nil {
		return nil
	}
	out := new(MonitoredProjectStatus)
	in.DeepCopyInto(out)
	return out
}
