	...
	if mg.Spec.ForProvider.AttestationAuthorityNote != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.AttestationAuthorityNote.NoteReference, ""),
		...
		mg.Spec.ForProvider.AttestationAuthorityNote.NoteReference = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.InitProvider.AttestationAuthorityNote != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.AttestationAuthorityNote.NoteReference, ""),
				Extract:      reference.ExternalName(),
		...
		mg.Spec.InitProvider.AttestationAuthorityNote.NoteReference = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.ForProvider.DefaultAdmissionRule != nil {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.ForProvider.DefaultAdmissionRule.RequireAttestationsBy),
				Extract:       reference.ExternalName(),
		...
		mg.Spec.ForProvider.DefaultAdmissionRule.RequireAttestationsBy = helper.ToPtrValues(mrsp.ResolvedValues)
	...
	if mg.Spec.InitProvider.DefaultAdmissionRule != nil {
		{
			...
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
				CurrentValues: helper.FromPtrValues(mg.Spec.InitProvider.DefaultAdmissionRule.RequireAttestationsBy),
				Extract:       reference.ExternalName(),
		...
		mg.Spec.InitProvider.DefaultAdmissionRule.RequireAttestationsBy = helper.ToPtrValues(mrsp.ResolvedValues)
