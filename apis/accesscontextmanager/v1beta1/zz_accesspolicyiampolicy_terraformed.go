...
func (tr *AccessPolicyIAMPolicy) GetObservation() (map[string]any, error) {
...
func (tr *AccessPolicyIAMPolicy) SetObservation(obs map[string]any) error {
...
func (tr *AccessPolicyIAMPolicy) GetParameters() (map[string]any, error) {
...
func (tr *AccessPolicyIAMPolicy) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AccessPolicyIAMPolicy
func (tr *AccessPolicyIAMPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AccessPolicyIAMPolicy
func (tr *AccessPolicyIAMPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
