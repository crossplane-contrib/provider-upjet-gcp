...
func (tr *ServiceSplitTraffic) GetObservation() (map[string]any, error) {
...
func (tr *ServiceSplitTraffic) SetObservation(obs map[string]any) error {
...
func (tr *ServiceSplitTraffic) GetParameters() (map[string]any, error) {
...
func (tr *ServiceSplitTraffic) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ServiceSplitTraffic
func (tr *ServiceSplitTraffic) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ServiceSplitTraffic
func (tr *ServiceSplitTraffic) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
