...
func (tr *FlexibleAppVersion) GetObservation() (map[string]any, error) {
...
func (tr *FlexibleAppVersion) SetObservation(obs map[string]any) error {
...
func (tr *FlexibleAppVersion) GetParameters() (map[string]any, error) {
...
func (tr *FlexibleAppVersion) SetParameters(params map[string]any) error {
...
// GetInitParameters of this FlexibleAppVersion
func (tr *FlexibleAppVersion) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this FlexibleAppVersion
func (tr *FlexibleAppVersion) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
