...
func (mg *KafkaACL) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this KafkaACL.
func (mg *KafkaACL) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *KafkaACL) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this KafkaACL.
func (mg *KafkaACL) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
