...
func (in *GatewayInitParameters) DeepCopyInto(out *GatewayInitParameters) {
	*out = *in
	...
	if in.IPRangeReservations != nil {
		in, out := &in.IPRangeReservations, &out.IPRangeReservations
		*out = make([]IPRangeReservationsInitParameters, len(*in))
		for i := range *in {
...
func (in *GatewayObservation) DeepCopyInto(out *GatewayObservation) {
	*out = *in
	...
	if in.IPRangeReservations != nil {
		in, out := &in.IPRangeReservations, &out.IPRangeReservations
		*out = make([]IPRangeReservationsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GatewayParameters) DeepCopyInto(out *GatewayParameters) {
	*out = *in
	...
	if in.IPRangeReservations != nil {
		in, out := &in.IPRangeReservations, &out.IPRangeReservations
		*out = make([]IPRangeReservationsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPRangeReservationsInitParameters) DeepCopyInto(out *IPRangeReservationsInitParameters) {
	*out = *in
	if in.IPRange != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPRangeReservationsInitParameters.
func (in *IPRangeReservationsInitParameters) DeepCopy() *IPRangeReservationsInitParameters {
	if in == nil {
		return nil
	}
	out := new(IPRangeReservationsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPRangeReservationsObservation) DeepCopyInto(out *IPRangeReservationsObservation) {
	*out = *in
	if in.IPRange != nil {
		in, out := &in.IPRange, &out.IPRange
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPRangeReservationsObservation.
func (in *IPRangeReservationsObservation) DeepCopy() *IPRangeReservationsObservation {
	if in == nil {
		return nil
	}
	out := new(IPRangeReservationsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPRangeReservationsParameters) DeepCopyInto(out *IPRangeReservationsParameters) {
	*out = *in
	if in.IPRange != nil {
		in, out := &in.IPRange, &out.IPRange
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPRangeReservationsParameters.
func (in *IPRangeReservationsParameters) DeepCopy() *IPRangeReservationsParameters {
	if in == nil {
		return nil
	}
	out := new(IPRangeReservationsParameters)
	in.DeepCopyInto(out)
	return out
}
