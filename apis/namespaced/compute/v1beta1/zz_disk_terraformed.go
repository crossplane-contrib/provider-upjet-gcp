...
func (tr *Disk) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"disk_encryption_key[*].raw_key": "diskEncryptionKey.rawKeySecretRef", "disk_encryption_key[*].rsa_encrypted_key": "diskEncryptionKey.rsaEncryptedKeySecretRef", "source_image_encryption_key[*].raw_key": "sourceImageEncryptionKey.rawKeySecretRef", "source_snapshot_encryption_key[*].raw_key": "sourceSnapshotEncryptionKey.rawKeySecretRef"}
}
