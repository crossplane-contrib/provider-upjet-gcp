...
func (tr *BackendService) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"iap[*].oauth2_client_id": "iap.oauth2ClientIdSecretRef", "iap[*].oauth2_client_secret": "iap.oauth2ClientSecretSecretRef", "iap[*].oauth2_client_secret_sha256": "status.atProvider.iap.oauth2ClientSecretSha256", "security_settings[*].aws_v4_authentication[*].access_key": "securitySettings.awsV4Authentication.accessKeySecretRef"}
}
