...
import (
	...
	compute "github.com/upbound/provider-gcp/v3/config/namespaced/compute"
...
func (mg *RegionBackendService) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.NetworkRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionSecurityPolicy", "RegionSecurityPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionTargetHTTPSProxy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("networksecurity.gcp.m.upbound.io", "v1beta1", "ServerTLSPolicy", "ServerTLSPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Router) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("networkconnectivity.gcp.m.upbound.io", "v1beta1", "Spoke", "SpokeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
