...
type BackendAuthenticationConfigInitParameters struct {
	...
	ClientCertificateRef *v2.NamespacedReference `json:"clientCertificateRef,omitempty" tf:"-"`

	// Selector for a Certificate in certificatemanager to populate clientCertificate.
	// +kubebuilder:validation:Optional
	ClientCertificateSelector *v2.NamespacedSelector `json:"clientCertificateSelector,omitempty" tf:"-"`
