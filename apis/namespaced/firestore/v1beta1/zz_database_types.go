...
type DatabaseInitParameters struct {
	...
	FirestoreDataAccessMode *string `json:"firestoreDataAccessMode,omitempty" tf:"firestore_data_access_mode,omitempty"`
	...
	// Possible values are: DATA_ACCESS_MODE_ENABLED, DATA_ACCESS_MODE_DISABLED.
	MongodbCompatibleDataAccessMode *string `json:"mongodbCompatibleDataAccessMode,omitempty" tf:"mongodb_compatible_data_access_mode,omitempty"`
	...
	RealtimeUpdatesMode *string `json:"realtimeUpdatesMode,omitempty" tf:"realtime_updates_mode,omitempty"`
