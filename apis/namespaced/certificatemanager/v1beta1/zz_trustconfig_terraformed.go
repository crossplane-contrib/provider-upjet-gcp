...
func (tr *TrustConfig) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"trust_stores[*].intermediate_cas[*].pem_certificate": "trustStores[*].intermediateCas[*].pemCertificateSecretRef", "trust_stores[*].trust_anchors[*].pem_certificate": "trustStores[*].trustAnchors[*].pemCertificateSecretRef"}
}
...
// LateInitialize this TrustConfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TrustConfig) LateInitialize(attrs []byte) (bool, error) {
	params := &TrustConfigParameters{}
