...
func (mg *IdsEndpoint) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this IdsEndpoint.
func (mg *IdsEndpoint) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *IdsEndpoint) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this IdsEndpoint.
func (mg *IdsEndpoint) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
