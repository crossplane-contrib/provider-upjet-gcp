	...
	if mg.Spec.ForProvider.Gateway != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.Gateway.AppGateway, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.ForProvider.Gateway.AppGateway = ptr.To(rsp.ResolvedValue)
	...
	if mg.Spec.InitProvider.Gateway != nil {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.Gateway.AppGateway, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.Gateway.AppGateway = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.ForProvider.PrincipalInfo.ServiceAccount != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.PrincipalInfo.ServiceAccount.Email, ""),
			...
			mg.Spec.ForProvider.PrincipalInfo.ServiceAccount.Email = ptr.To(rsp.ResolvedValue)
		...
		if mg.Spec.InitProvider.PrincipalInfo.ServiceAccount != nil {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.PrincipalInfo.ServiceAccount.Email, ""),
					Extract:      resource.ExtractParamPath("email", true),
			...
			mg.Spec.InitProvider.PrincipalInfo.ServiceAccount.Email = ptr.To(rsp.ResolvedValue)
