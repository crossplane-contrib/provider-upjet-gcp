	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.SubordinateConfig); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.SubordinateConfig[i3].CertificateAuthority, ""),
		...
		mg.Spec.ForProvider.SubordinateConfig[i3].CertificateAuthority = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.SubordinateConfig); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.SubordinateConfig[i3].CertificateAuthority, ""),
				Extract:      resource.ExtractParamPath("name", true),
		...
		mg.Spec.InitProvider.SubordinateConfig[i3].CertificateAuthority = ptr.To(rsp.ResolvedValue)
