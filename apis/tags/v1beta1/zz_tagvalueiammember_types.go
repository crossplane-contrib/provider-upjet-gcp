...
type TagValueIAMMemberConditionInitParameters struct {
...
type TagValueIAMMemberInitParameters struct {
	Condition []TagValueIAMMemberConditionInitParameters `json:"condition,omitempty" tf:"condition,omitempty"`
}

type TagValueIAMMemberObservation struct {
	Condition []TagValueIAMMemberConditionObservation `json:"condition,omitempty" tf:"condition,omitempty"`
...
type TagValueIAMMemberSpec struct {
	...
	// autoscaler.
	InitProvider TagValueIAMMemberInitParameters `json:"initProvider,omitempty"`
}
...
// TagValueIAMMember is the Schema for the TagValueIAMMembers API. <no value>
