...
// GetInitParameters of this TagTemplateIAMBinding
func (tr *TagTemplateIAMBinding) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TagTemplateIAMBinding
func (tr *TagTemplateIAMBinding) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
