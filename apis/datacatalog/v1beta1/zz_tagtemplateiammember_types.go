...
type TagTemplateIAMMemberConditionInitParameters struct {
...
type TagTemplateIAMMemberInitParameters struct {
	Condition *TagTemplateIAMMemberConditionInitParameters `json:"condition,omitempty" tf:"condition,omitempty"`
...
type TagTemplateIAMMemberObservation struct {
	Condition *TagTemplateIAMMemberConditionObservation `json:"condition,omitempty" tf:"condition,omitempty"`
...
type TagTemplateIAMMemberSpec struct {
	...
	// autoscaler.
	InitProvider TagTemplateIAMMemberInitParameters `json:"initProvider,omitempty"`
}
