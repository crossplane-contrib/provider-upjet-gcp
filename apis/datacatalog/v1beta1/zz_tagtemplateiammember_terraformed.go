...
// GetInitParameters of this TagTemplateIAMMember
func (tr *TagTemplateIAMMember) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TagTemplateIAMMember
func (tr *TagTemplateIAMMember) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
