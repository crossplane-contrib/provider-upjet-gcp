		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.BackupConfig[i3].EncryptionKey); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.ForProvider.BackupConfig[i3].EncryptionKey[i4].GCPKMSEncryptionKey, ""),
			...
			mg.Spec.ForProvider.BackupConfig[i3].EncryptionKey[i4].GCPKMSEncryptionKey = ptr.To(rsp.ResolvedValue)
		...
		for i4 := 0; i4 < len(mg.Spec.InitProvider.BackupConfig[i3].EncryptionKey); i4++ {
			{
				...
				rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
					CurrentValue: ptr.Deref(mg.Spec.InitProvider.BackupConfig[i3].EncryptionKey[i4].GCPKMSEncryptionKey, ""),
					Extract:      resource.ExtractResourceID(),
			...
			mg.Spec.InitProvider.BackupConfig[i3].EncryptionKey[i4].GCPKMSEncryptionKey = ptr.To(rsp.ResolvedValue)
