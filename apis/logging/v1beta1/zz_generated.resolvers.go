	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CmekSettings); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.ForProvider.CmekSettings[i3].KMSKeyName, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.ForProvider.CmekSettings[i3].KMSKeyName = ptr.To(rsp.ResolvedValue)
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.CmekSettings); i3++ {
		{
			...
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				CurrentValue: ptr.Deref(mg.Spec.InitProvider.CmekSettings[i3].KMSKeyName, ""),
				Extract:      resource.ExtractResourceID(),
		...
		mg.Spec.InitProvider.CmekSettings[i3].KMSKeyName = ptr.To(rsp.ResolvedValue)
