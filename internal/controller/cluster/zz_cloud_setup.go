...
// SetupWebhookWithManager_cloud registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_cloud(mgr ctrl.Manager) error {
