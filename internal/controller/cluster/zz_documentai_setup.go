...
// SetupWebhookWithManager_documentai registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_documentai(mgr ctrl.Manager) error {
