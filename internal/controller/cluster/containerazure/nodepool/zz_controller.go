...
import (
	...
	v1beta2 "github.com/upbound/provider-gcp/v2/apis/cluster/containerazure/v1beta2"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta2.NodePool_GroupVersionKind)))
	...
	// register webhooks for the kind v1beta2.NodePool if they're enabled.
	if o.StartWebhooks {
