...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewNoForkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["google_bigquery_reservation"],
				...
				tjcontroller.WithNoForkAsyncMetricRecorder(metrics.NewMetricRecorder(v1beta1.Reservation_GroupVersionKind, mgr, o.PollInterval)),
