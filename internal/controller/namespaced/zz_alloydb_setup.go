...
// SetupWebhookWithManager_alloydb registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_alloydb(mgr ctrl.Manager) error {
