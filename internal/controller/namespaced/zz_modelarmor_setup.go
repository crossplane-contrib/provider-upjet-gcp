...
// SetupWebhookWithManager_modelarmor registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_modelarmor(mgr ctrl.Manager) error {
