...
// SetupWebhookWithManager_cloudquotas registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_cloudquotas(mgr ctrl.Manager) error {
