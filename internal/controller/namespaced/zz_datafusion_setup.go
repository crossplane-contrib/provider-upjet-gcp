...
import (
	...
	instance "github.com/upbound/provider-gcp/v3/internal/controller/namespaced/datafusion/instance"
)
...
// SetupWebhookWithManager_datafusion registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_datafusion(mgr ctrl.Manager) error {
