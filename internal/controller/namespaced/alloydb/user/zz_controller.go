...
import (
	...
	v1beta1 "github.com/upbound/provider-gcp/v3/apis/namespaced/alloydb/v1beta1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["google_alloydb_user"],
