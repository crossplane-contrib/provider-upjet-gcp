...
import (
	...
	v1beta1 "github.com/upbound/provider-gcp/v2/apis/namespaced/sql/v1beta1"
	"github.com/upbound/provider-gcp/v2/internal/clients"
	features "github.com/upbound/provider-gcp/v2/internal/features"
)

// SetupWebhookWithManager registers the conversion webhook for SourceRepresentationInstance.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.SourceRepresentationInstance{}).
		Complete(); err != nil {
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.SourceRepresentationInstance_GroupVersionKind)))
