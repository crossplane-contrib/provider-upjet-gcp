...
import (
	...
	cluster "github.com/upbound/provider-gcp/v3/internal/controller/namespaced/containeraws/cluster"
	nodepool "github.com/upbound/provider-gcp/v3/internal/controller/namespaced/containeraws/nodepool"
)
...
// SetupWebhookWithManager_containeraws registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_containeraws(mgr ctrl.Manager) error {
