...
// SetupWebhookWithManager registers the conversion webhook for LiteSubscription.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.LiteSubscription{}).
		Complete(); err != nil {
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.LiteSubscription_GroupVersionKind)))
