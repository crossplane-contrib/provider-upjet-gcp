...
// SetupWebhookWithManager_cloudbuild registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_cloudbuild(mgr ctrl.Manager) error {
